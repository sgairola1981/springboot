package com.gairola.spring.springintegration.config;
...
public class SpringIntegrationConfig {
    ...
    public FileReadingMessageSource fileReadingMessageSource() {
        ...
        readder.setDirectory(new File("C:\\data"));
    ...
    public FileWritingMessageHandler fileWritingMessageHandler() {
        FileWritingMessageHandler writter = new FileWritingMessageHandler(
                new File("C:\\Destination"));
