package com.gairola.webfluxdemo.service;
...
import com.gairola.webfluxdemo.repository.TutorialRepository;
...
public class TutorialService {
  ...
  public Flux<Tutorial> findByTitleContaining(String title) {
    return tutorialRepository.findByTitleContaining(title).delayElements(Duration.ofMillis(2500));
  }
